...
SESSION_CONFIGS = [
    ...
    {
        'name': 'blurry_ranking_es',
        'display_name': "blurry_ranking_es",
        'num_demo_participants': 28,
        'app_sequence': ['task_sums','given_type', 'name_es', 'inst_fixed_es', 'fixed_es', 'inst_fluid_es', 'fluid_es', 'alloc_es', 'pay_es'],
        'treatment': 3,
        # 'use_browser_bots': True
    },
    # {
    #     'name': 'sticky_ranking_cost_es',
    #     'display_name': "sticky_ranking_cost_es",
    ...
    # },
    # {
    #     'name': 'blurry_ranking_cost_es',
    #     'display_name': "blurry_ranking_cost_es",
    #     'num_demo_participants': 14,
    #     'app_sequence': ['task_sums', 'given_type','name_es', 'inst_fixed_es', 'fixed_es', 'inst_fluid_es', 'fluid_es', 'alloc_es', 'pay_es'],
    #     'treatment': 6,
    #     # 'use_browser_bots': True
    # },
    # {
    #     'name': 'full_ranking_es',
    #     'display_name': "full_ranking_es",
    #     'num_demo_participants': 28,
    #     'app_sequence': ['task_sums','given_type','name_es', 'inst_fixed_es', 'fixed_es', 'inst_fluid_es', 'fluid_es', 'alloc_es', 'pay_es'],
    #     'treatment': 1,
    #     # 'use_browser_bots': True
    # },
    # {
    #     'name': 'full_ranking_cost_es',
    #     'display_name': "full_ranking_cost_es",
    #     'num_demo_participants': 28,
    #     'app_sequence': ['task_sums','given_type','name_es', 'inst_fixed_es', 'fixed_es', 'inst_fluid_es', 'fluid_es', 'alloc_es', 'pay_es'],
    #     'treatment': 4,
    #     # 'use_browser_bots': True
